          ...
          <FadeIn delay={0.2}>
            <div className="text-center">
              ...
              <div className="bg-white/10 rounded-lg overflow-hidden mb-4">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d0!2d0!3d0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s1sCinnamon+Indian+Restaurant+Castletown+Isle+of+Man!5e0!3m2!1sen!2sim!4v1234567890"
                  width="100%"
                  height="200"
                  style={{ border: 0 }}
                  allowFullScreen
